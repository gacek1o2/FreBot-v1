...
Kod został w całości stworzony przez Łukasz Borowskiego z pomocą poradników dostępnych pod tym linkiem: https://www.youtube.com/playlist?list=PLyBTvYfUy4lHGPCPo1TIc72x_-TQgFAc0

jeżeli coś zostało zapisane w nawiasach kwadratowych np. [ping] to znaczy że należy zastąpić tym co jest napisane w środku w tym przypadku pingiem jaki chce się uzyskać

w przypadku problemów z konfiguracją bota można łatwo znaleźć informacje w internecie lub można napisać na githubie lub discordzie do autora(discord: nick:Gacek tag:#0628)
